...
const FishBoxSentForm: React.FC = () => {
  ...
  const fieldOrder: (keyof BoxSentItem)[] = ['customer', 'boxCount'];
    ...
    try {
      ...
      if (draftData) {
        ...
        setSalesData({
          ...
          salesman: parsedData.salesman || '',
          totalBox: parsedData.totalBox || '0',
  ...
  const handleKeyDown = (
    ...
    if (e.key === 'Enter') {
      ...
      const currentIndex = fieldOrder.indexOf(currentField as keyof BoxSentItem);
      if (currentIndex === -1) return;
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600 p-6 h-[600px] flex flex-col">
          <div className="flex justify-between items-center mb-6 flex-shrink-0">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Box Sale</h1>
          </div>
          ...
          <div className="flex-1 overflow-y-scroll" style={{ maxHeight: '300px' }}>
            {/* Items Table */}
