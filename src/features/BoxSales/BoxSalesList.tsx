...
// fariz update chyth thetti poya code review excluded thazhe
...
//       e.preventDefault();
//       const currentItemIndex = editData?.items.findIndex(item => item.id === itemId) ?? -1;
//       if (currentItemIndex !== -1 && currentItemIndex < (editData?.items.length ?? 0) - 1) {
//         const nextItem = editData!.items[currentItemIndex + 1];
//         setTimeout(() => {
//           let selector;
//           if (field === 'box') {
//             selector = `input[data-item-id="${nextItem.id}"][data-field="${field}"]`;
//             const el = document.querySelector(selector) as HTMLInputElement;
//             el?.focus();
//             el?.select();
//           } else {
//             selector = `[data-item-id="${nextItem.id}"][data-field="${field}"] input`;
//             const el = document.querySelector(selector) as HTMLInputElement;
//             el?.focus();
//             el?.select();
//           }
...
//       const currentItemIndex = editData?.items.findIndex(item => item.id === itemId) ?? -1;
//       if (currentItemIndex > 0) {
//         const prevItem = editData!.items[currentItemIndex - 1];
//         setTimeout(() => {
//           let selector;
//           if (field === 'box') {
//             selector = `input[data-item-id="${prevItem.id}"][data-field="${field}"]`;
//             const el = document.querySelector(selector) as HTMLInputElement;
//             el?.focus();
//             el?.select();
//           } else {
//             selector = `[data-item-id="${prevItem.id}"][data-field="${field}"] input`;
//             const el = document.querySelector(selector) as HTMLInputElement;
//             el?.focus();
//             el?.select();
//           }
