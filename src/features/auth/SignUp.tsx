...
//       if (status === 409) alert(msg || 'Email or username already in use');
//       else if (status === 400) alert(msg || 'Invalid input');
//       else alert(msg || 'Something went wrong. Try again.');
//     } else {
...
//                 <UserPlus className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-500 w-5 h-5" />
//                 <input
//                   type="text"
//                   value={fullName}
...
//                       ? 'border-red-300 bg-red-50 dark:border-red-600 dark:bg-red-900/20 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400'
    ...
    try {
      ...
      if (err?.response) {
        ...
        if (err.response.status === 409)
          alert(msg || 'Email or username already exists');
        else if (err.response.status === 400)
          alert(msg || 'Invalid input');
          ...
          <form onSubmit={handleSignUp} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full pl-3 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                required
              >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={confirmPassword}
                  onChange={(e) => setConfirmPassword(e.target.value)}
                  className={`w-full pl-10 pr-4 py-3 border rounded-lg ${confirmPassword && !passwordsMatch
            ...
            <button
              ...
              className="w-full bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-500 transition-all disabled:bg-gray-400 dark:disabled:bg-gray-600"
            >
              {loading ? 'Signing up...' : 'Sign Up'}
            </button>
          </form>
