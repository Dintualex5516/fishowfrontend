                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300 print:hidden">
                        <input
                          ...
                          onKeyDown={(e) => {
                            if (e.key === 'ArrowDown') {
                              e.preventDefault();
                              const nextInput = document.querySelector(`input[data-row-index="${index + 1}"][data-col-type="paid"]`) as HTMLInputElement;
                              nextInput?.focus();
                              nextInput?.select();
                            } else if (e.key === 'ArrowUp') {
                              e.preventDefault();
                              const prevInput = document.querySelector(`input[data-row-index="${index - 1}"][data-col-type="paid"]`) as HTMLInputElement;
                              prevInput?.focus();
                              prevInput?.select();
                            }
                          }}
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300 print:hidden">
                        <input
                          ...
                          onKeyDown={(e) => {
                            if (e.key === 'ArrowDown') {
                              e.preventDefault();
                              const nextInput = document.querySelector(`input[data-row-index="${index + 1}"][data-col-type="discount"]`) as HTMLInputElement;
                              nextInput?.focus();
                              nextInput?.select();
                            } else if (e.key === 'ArrowUp') {
                              e.preventDefault();
                              const prevInput = document.querySelector(`input[data-row-index="${index - 1}"][data-col-type="discount"]`) as HTMLInputElement;
                              prevInput?.focus();
                              prevInput?.select();
                            }
                          }}
